...
public class LongestSubstrAtmostK {
    ...
    // Run slightly better than Optimal because we are not using while loop

    static int longestSuperOptimal (String s, int k) {
        int left = 0;
        int cnt = 0;
        HashMap<Character, Integer> mpp = new HashMap<>();
    ...
    public static void main(String[] args) {
        String s = "aaabbccd";
        int k = 2;
        System.out.println(longestBrute(s, k));
        System.out.println(longestOptimal(s, k));
        System.out.println(longestSuperOptimal(s, k));
    }
}
